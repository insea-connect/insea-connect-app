...
public class DriveItemController {
    ...
    public List<DriveItem> getDriveItems(@PathVariable Long degreePathCode) {
        return null;
    }

    @PostMapping("/degreePaths/{degreePathCode}/items")
    public void CreateDriveItem(@PathVariable Long degreePathCode, @RequestBody DriveItem driveItem) {
    }
}
